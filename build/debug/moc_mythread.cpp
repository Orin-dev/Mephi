...
QT_MOC_LITERAL(3, 15, 16), // "receiveGlobalVar"
QT_MOC_LITERAL(4, 32, 1) // "i"

    },
    "MyThread\0send\0\0receiveGlobalVar\0i"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->receiveGlobalVar((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::send)) {
                *result = 0;
            }
        }
    }
