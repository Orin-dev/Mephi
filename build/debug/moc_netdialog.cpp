...
void NetDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (NetDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetDialog::apply)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject NetDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_NetDialog.data,
      qt_meta_data_NetDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NetDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NetDialog.stringdata))
